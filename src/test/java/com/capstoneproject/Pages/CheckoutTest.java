...
public class CheckoutTest extends BestBuyTest {
    ...
    public void checkout() {
        ...
        WebElement continueButton = wait.until(ExpectedConditions.presenceOfElementLocated(By.xpath("//a[@class='btn btn-secondary btn-block btn-lg']")));
       ...
       // WebElement checkoutButton = wait.until(ExpectedConditions.elementToBeClickable(By.cssSelector(".btn-primary")));
